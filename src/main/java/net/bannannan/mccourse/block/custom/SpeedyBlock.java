    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if(world.isClient()){
            if(hand == Hand.MAIN_HAND){
                player.sendMessage(new LiteralText("CLIENT : This is THE CLIENT. MAIN_HAND."),false);
            } else {
                player.sendMessage(new LiteralText("CLIENT : This is THE CLIENT. OFF_HAND."),false);
            }
        }
